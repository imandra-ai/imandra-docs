{%- extends 'skeleton/display_priority.tpl' -%}


{% block codecell %}
<div class="cell border-box-sizing code_cell rendered">
<div class="try-this-container">
  <a href="{{ try_notebook_url }}%23try-cell-{{ cell_index }}" target="_blank" rel="nofollow">
...
<div class="text_cell_render border-box-sizing rendered_html">
  {%- if cell.source.startswith('```sh.copy') -%}
  ...
  <div class="terminal">
    ...
    <code>
    {{ cell.source.replace('```sh.copy', '```sh')  | markdown2html | strip_files_prefix }}
    </code>
    <div id="copy-button-id--{{ button_id[0] }}" class="terminal__copy-cover">
      <img src="/{{ repo_dir }}/static/img/copy.svg">
    </div>
  </div>
  <script>document.getElementById('copy-button-id--{{ button_id[0] }}').addEventListener('click', handleCopyClick);</script>

  {# increment count by 1 #}
  {% if button_id.append(button_id.pop() + 1) %}{% endif %}
